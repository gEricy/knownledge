...
（2）乐观锁：MySql最经常使用的乐观锁是进行**version版本控制**（在[分布式锁](https://github.com/gEricy/knownledge/blob/master/X_%E5%88%86%E5%B8%83%E5%BC%8F/%E5%88%86%E5%B8%83%E5%BC%8F%E9%94%81.md)中，讲到过SQL的乐观锁/幂等），也就是在数据库表中增加一列，记为version。
...
① **从数据库**开启IO线程，**主动**拉取binlog，保存为中继日志Relay log 
